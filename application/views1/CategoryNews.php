...
<div class="container-fluid bg-3"> 
  <div class="row">
    <div class="col-md-12"> 
      <div class="col-sm-6">
        <!--<p>Some text..</p>-->
        <img src="<?php echo base_url().'uploads/images/'.$results[0]['picture']; ?>" class="img-responsive" style="width:100%" alt="Image"><span><a><?php echo $results[0]['Title']; ?></a></span>
      </div>
      <h2>Latest News</h2>	  
      <div class="col-sm-3">
	   <div class="row">
   ...
   <div class="row">  
	 ...
	 ?>
	  <div class="col-sm-3"> 
	    <div class="media">
          <div class="media-left">
             <img src="<?php echo base_url().'uploads/images/'.$val['picture']; ?>" class="media-object" style="width:100px">
          </div>
          <div class="media-body">
            <h4 class="media-heading"><?php echo $val['category']; ?></h4>
            <p><a href="<?php echo base_url().'admin/LatestNews/'.$val['id']; ?>"><?php echo $val['Title']; ?></a></p>
	    ...
	    ?>
	     <div class="col-sm-3"> 
	      <div class="media">
            ...
            <div class="media-body">
             <h4 class="media-heading"><?php echo $val['subcategory']; ?></h4>
             <p><a href="<?php echo base_url().'admin/'.$val['category'].'/'.$val['id']; ?>"><?php echo $val['Title']; ?></a></p>
            </div>       
          </div>	
         </div>
