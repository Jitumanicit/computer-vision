		   ...
		   ?>	
			...
			<div class='col-sm-6'>                    
              <div class="form-group">
                ...
                <div class='input-group date'>
                   <input type='text' class="form-control" id="mobile_no" name="mobile_no" onkeypress="return isNumberKey(event)" maxlength="10" placeholder="10 digit only" required><!--   pattern="[1-9]{1}[0-9]{9}" -->                   
                </div>
              </div>
            </div>
			...
			<div class='col-sm-6'>                  
              <div class="form-group">
                 ...
                 <div class='input-group'>
                   <input type='file' id="picture" name="picture" required><b style="color:red" id="PositionImage"></b>                  
                 </div>
              </div>
            </div>
