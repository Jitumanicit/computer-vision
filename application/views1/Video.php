...
<div class="container-fluid bg-3 text-center">    
  ...
  <div class="row">
    ...
    <div  class="col-sm-6">
		...
		?>	
		  <div class="embed-responsive embed-responsive-16by9">
		    <iframe width="820" height="540"  src="<?php echo 'https://www.youtube.com/embed/'.$val['Url']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		  </div>
        <?php		
		}
		else
	...
	<div class="col-sm-6">
	 <p><h4></h4></p>
	<p><?php echo $val['Contents'].'<br>';?><br></p></div>
	 <br><br><br>
	</div>
	<?php } ?>	
  </div>
