              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <!--<img src="images/img.jpg" alt="">--><?php echo $sessarrs1['username']; ?>
		   ...
		   <form method="post" action="<?php echo base_url().'admin/saveAdvertise';?>" enctype="multipart/form-data">            
			...
			<div class='col-sm-6'>                    
              <div class="form-group">
			    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Customer Name <span class="required">*</span></label>
                <div class='input-group'>
                   <input type='text' class="form-control" id="customer_name" name="customer_name" value="<?php echo $result[0]['customer_name']; ?>">
			...
			<div class='col-sm-6'>                    
              <div class="form-group">
                ...
                <div class='input-group date'>
                   <input type='text' class="form-control" id="mobile_no" name="mobile_no" value="<?php echo $result[0]['mobile_no']; ?>" placeholder="10 digit only">                   
                </div>
              </div>
            </div>
			...
			<div class='col-sm-6'>                    
              <div class="form-group">
			    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Email Id <span class="required">*</span></label>
                <div class='input-group date'>
			...
			<div class='col-sm-6'>                    
             <div class="form-group">
			   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> On Date <span class="required">*</span></label>
			...
			<div class='col-sm-6'>                    
              <div class="form-group">
			   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Till Date <span class="required">*</span></label>
            ...
            <div class='col-sm-6'>                  
              <div class="form-group">
			    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> On Time <span class="required">*</span></label>
			...
			<div class='col-sm-6'>                  
              <div class="form-group">
			    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Upto Time <span class="required">*</span></label>
			...
			<div class='col-sm-6'>                  
              <div class="form-group">
			    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Image Position <span class="required">*</span></label>
                <div class='input-group'>                 
                  <select name="img_position" id="img_position" class="form-control" onchange="Position(this.value)">			     
					...
					<option value="Boottom" <?php if($result[0]['img_position'] == 'Bottom') echo 'selected="selected"'; ?>>Bottom</option>					   				   
				  </select>
                </div>
              </div>
            </div>			
			<div class='col-sm-6'>                  
              <div class="form-group">
			    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Image Upload <span class="required">*</span></label>
                <div class='input-group'>
                   <input type='file' id="picture" name="picture"><b style="color:red" id="PositionImage"></b> 
  ...
  <footer>
    ...
    <script>
	   ...
	   {		   
		   ...
		   {
			 $('#PositionImage').html('Image 1200x261 (Only jpg,png,gif format allowed)');
		   }
		   else if("Bottom"==val)		   
		   {
			 $('#PositionImage').html('Image 800x450 (Only jpg,png,gif format allowed)');
