                   ...
                   <br/>									
                    <form id="postdata" method="post" class="form-horizontal form-label-left" action="<?php echo base_url().'admin/NewReporter';?>" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                           <input type="text" id="pan_card" name="pan_card" class="form-control col-md-7 col-xs-12" pattern="[A-Z]{4}\d{4}[A-Z]{1}" Title="EX -AAAA0000A" required> 
                        </div>		
                      </div>
					  ...
					  <div class="form-group">                        				 
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="reporter_id" name="reporter_id" class="form-control col-md-7 col-xs-12" required> 
                        </div>	
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Address Proof<span class="required">*</span></label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                           <input type="file" id="address_proof" name="address_proof" required><b style="color:red">(Only jpg,png,gif format allowed)</b> 
                        </div>							
                      </div>                    
