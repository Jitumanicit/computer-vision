        ...
        <div class="clearfix"></div>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Reporter Registration</h2>
               ...
               <div class="alert alert-danger alert-dismissible">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> 
                  <?php if($user!=''){ echo $user."<br>";} if($pass!=''){ echo $pass."<br>";} if($emailid!=''){ echo $emailid."<br>";} if($phone!=''){ echo $phone."<br>";}  if($reporter!=''){ echo $reporter."<br>";} if($pancard!=''){ echo $pancard."<br>";} if($passerror!=''){ echo $passerror."<br>";} if($phoneerror!=''){ echo $phoneerror."<br>";}   ?>
               </div>
				       <?php
				        }
				       ?>							
              ...
              <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Username</label>
               <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" id="Username" name="Username" value="<?php echo $result[0]['username']; ?>" class="form-control col-md-7 col-xs-12" onkeypress="return testInput(event)" required>
               ...
               <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" id="reporter_name" name="reporter_name" value="<?php echo $result[0]['reporter_name']; ?>" class="form-control col-md-7 col-xs-12" onkeypress="return testInputpRoprterName(event)" required>
               </div>   
            ...
            <div class="form-group">
               ...
               <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Pan Card</label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" id="pan_card" name="pan_card" value="<?php echo $result[0]['pan_card']; ?>" class="form-control col-md-7 col-xs-12" pattern="[A-Z]{5}\d{4}[A-Z]{1}" Title="EX -AAAAA0000A" onkeypress="return testInputPancard(event)" required> 
                </div> 
            </div>
               ...
               <div class="col-md-4 col-sm-4 col-xs-12">
                 <input type="text" id="reporter_id" name="reporter_id" value="<?php echo $result[0]['reporter_id']; ?>" class="form-control col-md-7 col-xs-12" readonly> 
               </div>		
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                 <img src="<?php echo base_url().'uploads/images/'.$result[0]['address_proof'];?>" id="pics1" height="100" width="100">
                 <input type="file" id="address_proof" name="address_proof" onchange="previewFile1()" style="color: transparent;"><b style="color:red">(Only jpg,png,gif format allowed)</b> 
...
<script>
	    function success(id)
   	   { 
           ...
           var url = hostname +"admin/editrepoter/"+id; 
