	                     ...
	                     ?>
					      <tr>
							 ...
							 <?php
							   ...
							   {							    					 							 
							     ?>	
							      <a href="<?php echo base_url().'admin/deletes/'.$val['id'];?>" onclick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true" style="color:#d9534f; font-size: 1.5em;"></i></a>
							     <?php 							   
							   }
							   else
							   {
								 if($val['status']=='0'&&$val['recent']=='0')
								  {								 
							     ?>	
							      <a href="<?php echo base_url().'admin/deletesVideo/'.$val['id'];?>" onclick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true" style="color:#d9534f; font-size: 1.5em;"></i></a>
							     <?php 							   
							     }
				   ...
				   {						   
					 ...
					 if("youtube"==response.results[0]['Types'])
					 {
					  // $("#pic").html(response.results[0]['Url']);
					    var option =response.results[0]['Url'];
					    
					   //alert(html(option));
					   $("#pic").html('<iframe width="560" height="315" src="https://www.youtube.com/embed/'+ option +'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
					   
					  //$("#pic").html('<iframe width="560" height="315" src="'+ option +'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
					  /*$("#pic").html('<video width="560" height="315" controls><source src="' + response.results[0]['Url'] + '" type="video/mp4"></video>');*/
