<?php //include('header.php');?>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title"> 
                    <h2>View Sub Admin <small></small></h2>
                      ...
                      <tbody>
	                     ...
	                     ?> 
						  <tr>
                              ...
                              <td>
                               <!-- <a href="<?php echo base_url().'admin/deletesSubAdmin/'.$val['id'];?>" onclick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"  style="color:#d9534f; font-size: 1.5em;"></i></a>-->
                              <?php if($val['recent']==1){ ?>
                                  <a href="<?php echo base_url().'admin/deletesSubAdmin/'.$val['id'];?>" onclick="return confirm('Are you sure?');" class="btn btn-success btn-xs">Active</a><!--<i class="fa fa-trash" aria-hidden="true"  style="color:#d9534f; font-size: 1.5em;"></i>-->
                              <?php }else{ ?>
                                   <a href="<?php echo base_url().'admin/ActiveSubadmin/'.$val['id'];?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-xs">Inactive</a><!--<i class="fa fa-trash" aria-hidden="true"  style="color:#d9534f; font-size: 1.5em;"></i>-->
                              <?php } ?>
                                &nbsp&nbsp|&nbsp&nbsp<a href="<?php echo base_url().'admin/editregistration/'.$val['id'];?>"><i class="fa fa-pencil" aria-hidden="true" style="color:#4fd958; font-size: 1.5em;"></i></a>							  
							  </td>
                          </tr> 
						  <?php $i++; }} ?>   
                       </tbody>
    ...
    <script>
     ...
     var url =  hostname +"admin/viewSubAdmin";
		//var url = "http://"+ hostname +"/admin/viewSubAdmin/";
		// var url = "http://localhost/News/admin/viewSubAdmin/";
