  ...
  <script src="<?php echo base_url('assets/AdminPanel/js/jquery.min.js')?>"></script>	
    ...
    tinymce.PluginManager.add('instagram', function(editor, url) {
	 ...
	 tinymce.init({
        selector:'textarea',
		height: 300,
        toolbar: 'insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | print preview media fullpage | forecolor backcolor emoticons | instagram',
				  ...
				  <li>
				   ...
				   <ul class="nav child_menu">
					 ...
					 <?php
					  ...
					  {
					  ?>					  
                      <li><a href="<?php echo base_url().'admin/newVideo'; ?>"><i class="fa fa-edit"></i>Add Article With Video & Blog</a></li>;
					  <?php
					  }
					  ...
					  ?> 
                       ...
                       <li><a href="<?php echo base_url().'admin/viewBlog'; ?>"><i class="fa fa-eye"></i>View Blog</a></li>;                     
                      <?php
					  }
					  ?>
					</ul>
