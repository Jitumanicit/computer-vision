          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title"> 
                    <h2>View Article With Image<small></small></h2>
                ...
                <?php if($val['status']=='0')
								 {
								 ?>	
							     <th><a href="<?php echo base_url().'admin/postPublish/'.$val['id'];?>" class="btn btn-danger btn-xs"><b>UnPublish</b></a></th>	
                 <?php 
								 }
								 else
								 {
								 ?>							
                  <th><a class="btn btn-success btn-xs"><b>publish</b></a></th><!-- href="<?php echo base_url().'admin/postunPublish/'.$val['id'];?>"-->
							  <?php }} ?>				
                ...
                <td><?php echo $val['username'];?></td>
							...
							<!--- <td><a href="<?php echo base_url().'admin/deletesPost/'.$val['id'];?>" onclick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"  style="color:#d9534f; font-size: 1.5em;"></i></a>-->
                           <td>
							 <?php
               if($sessarrs1['status']==1||$sessarrs1['status']==2)
							   {	                 
                  ?>							 
							      <a href="<?php echo base_url().'admin/deletesPost/'.$val['id'];?>" onclick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true" style="color:#d9534f; font-size: 1.5em;"></i></a>
							     <?php 							    
                }
							  else
							   {
								  if($val['status']=='0'&&$val['recent']=='0')
								  {								 
							     ?>	
							      <a href="<?php echo base_url().'admin/deletesReporterPost/'.$val['id'];?>" onclick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true" style="color:#d9534f; font-size: 1.5em;"></i></a>
							     <?php 							   
							     }
                    else if($val['recent']=='1')
                   {
                     echo '<a class="btn btn-warning btn-xs"><b>Deleted</b></a>'; 
                   }
                 }
                ...
                if($sessarrs1['status']==3)
							   {
							     if($val['status']==0&&$val['recent']=='0')
								   {
								  ?>
							      &nbsp&nbsp|&nbsp&nbsp<a href="<?php echo base_url().'admin/editPost/'.$val['id'];?>"><i class="fa fa-pencil" aria-hidden="true" style="color:#4fd958; font-size: 1.5em;"></i></a>
							    <?php 
							     } 
							   } 
							   ?> 
	...
	<script>
	 function success()
		...
		//var hostname = $(location).attr('port');
    var hostname ="<?php echo base_url() ?>";
    //alert(hostname);
		var delay = 2000; 
		var url = hostname +"admin/viewPost";
    //var url = "http://"+ hostname +"/admin/viewPost/";
		//var url = "http://localhost/News/admin/viewPost/";
