                      ...
                      <tbody>
                         ...
                         if($results!='')
                         {
	                        ...
	                        ?> 
                              ...
                              <td><?php echo $val['img_position']; ?></td>
							                <td><a href="<?php echo base_url().'admin/deleteadvertise/'.$val['id'];?>"  onclick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true" style="color:#d9534f; font-size: 1.5em;"></i></a>&nbsp&nbsp|&nbsp&nbsp<a href="<?php echo base_url().'admin/editadvertise/'.$val['id'];?>"><i class="fa fa-pencil" aria-hidden="true" style="color:#4fd958; font-size: 1.5em;"></i></a> </td>
                          </tr> 
						              <?php $i++; }} ?>   
                       </tbody>
                     </table>
    ...
    var hostname ="<?php echo base_url() ?>";
		var delay    = 2000; 
    var url = hostname +"admin/view_advertise";
