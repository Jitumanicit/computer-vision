                    ...
                    <br/>									
                     <form id="postdata" method="post" class="form-horizontal form-label-left" action="<?php echo base_url().'admin/saveSubCategory';?>" enctype="multipart/form-data">
                       <div class="form-group">					   
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                              <input type="text" id="subcategory" name="subcategory" class="form-control col-md-7 col-xs-12 alphaonly" required>
                        </div>				 
                       </div> 	   
	...
	<script>
	  function success()
		     ...
		     var delay = 2000; 
		     //var url = "http://"+ hostname +"/admin/NewSubCategory/";
			   var hostname ="<?php echo base_url() ?>";
         var url =  hostname +"admin/NewSubCategory";     
