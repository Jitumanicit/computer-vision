...
<head>  
  ...
  <meta name="msapplication-starturl" content="http://newsner.in/News/Video"/>
  <link rel="canonical" href="http://newsner.in/News/Video"/>
  <meta name="robots" content="index, follow" />
  <meta property="og:type"   content="article" />
  <meta property="og:title" content="Newsner: Latest videos news, Breaking news videos & watch online news" />
  <meta property="og:url" content="http://newsner.in/News/Video" />
  ...
  <meta property="og:image" content="http://newsner.in/assets/images/MLF-BANNER-IMAGE-NEW1.jpg">
  ...
  <meta name="twitter:image" content="http://newsner.in/assets/images/MLF-BANNER-IMAGE-NEW1.jpg" />
...
<div id="header-area" class="header_area">
 <div class="header_bottom">
           ...
           <div class="jumbotron">
              <!--<div class="container text-center">   <h1>News</h1>   </div>-->
...
<div class="container-fluid bg-3" style="text-align: justify; text-justify:auto;">    
  ...
  //foreach($results as $val)
	...
	<div class="col-md-12"> 
   <div class="col-sm-8">          
    <p><h4><?php echo $results[$i]['Title'];?></h4></p>
		<?php if($results[$i]['Types']=="youtube")
		{
		?>	
		<div class="embed-responsive embed-responsive-16by9">
		   <iframe width="820" height="540"  src="<?php  echo 'https://www.youtube.com/embed/'.$results[$i]['Url']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
    <?php		
		}
		else
