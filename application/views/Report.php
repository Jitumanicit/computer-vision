          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title"> 
                    <h2>Report <?php $a = $this->uri->segment(2);  if($a=='ReportArticleImage'){ echo 'Image Article'; }else{ echo 'Video Article'; }?>    <small></small></h2>
	                     ...
	                     ?> 
						  <tr>
							  ...
							  <?php if($val['status']=='0')
							   {
							  ?>	
							   <th><a href="" class="btn btn-danger btn-xs"><b>Unpublish</b></a></th>
                              <?php 
							   }
							   else
							   {
							   ?>							
                               <th><a href="" class="btn btn-success btn-xs"><b>Publish</b></a></th>	
							  <?php
							   } 
							   ?>
                          </tr> 
