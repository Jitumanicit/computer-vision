...
<div id="header-area" class="header_area">
 <div class="header_bottom">
                    ...
                    <nav role="navigation" class="navbar navbar-default mainmenu">                
                        ...
                        <div id="navbarCollapse" class="collapse navbar-collapse">
                          <ul id="fresponsive" class="nav navbar-nav dropdown">
                            ...
                            <li><a href="<?php echo base_url().$uri_segments[1].'/video';?>">Blog</a></li>
           ...
           <div class="well"> 
             <div class="row">
               <div class="col-md-3">  
                 <a href="<?php echo base_url();?>"><img src="https://newsner.in/assets/images/Final Logo.jpg" alt="northeast latest news" class="img-responsive"></a>
              </div>
              <div class="col-md-9">  
                 <img src="https://newsner.in/assets/images/Final Banner.png" alt="northeast latest news" class="img-responsive">
              </div>
           </div>
        </div>
...
<div class="container-fluid bg-3" style="text-align: justify; text-justify:auto;">    
  ...
  <h3 style="border-bottom: 4px solid red; color: white; font-size: 16px;"><span style="background-color: red; padding: 4px;"><?php echo $results[$i]['Title'];?></span></h3> 
    <div class="col-sm-6"> 
        <img class="img-responsive" alt="northeast latest news" src="<?php echo base_url().'uploads/images/'.$results[$i]['picture']; ?>">
    </div>
    <div class="col-sm-6">
	     <span><?php echo $results[$i]['Contents'];?></span>
       <span style="border: 1px dashed red; padding: 5px; border-radius: 5%; font-weight: bold;">Updated by : <?php echo $results[$i]['created_at'];?></span>
	  </div> 
	</div>	 
	<?php } ?> 
