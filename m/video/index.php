...
<body>
  	...
  	<div class="container-fluid breaking">
  		<div class="row">
  			<ul id="ticker_03" class="ticker">
  				<?php
                      $sql=$video_page->top_breaking_news();
	...
	<div class="container-fluid mainContainer" style="margin-top: 10px;">
    	<div class="row">
    		<?php
            	$sql=$video_page->video_page_news();
                while($row=mysqli_fetch_array($sql))
                    {
                ?>
			<?php if($row['Types']=="youtube") { ?>
	    	<div class="card mb-3" style="width: 100%;">
	    	  <div class="card-body" style="padding: 0.25rem;">
	    	  	<p class="card-text text-center" style="color: #dc3545;"><?= $row['Title']; ?></p>
	    	  </div>
			  <iframe style="width: 100%;" class="embed-responsive-item" width="420" height="180" src="https://www.youtube.com/embed/<?= $row['Url']; ?>" allowfullscreen></iframe>
			  <div class="card-body" style="padding: 0.25rem;">
			    <p class="card-text"><?= $row['Contents']; ?></p>
			    <span class="badge badge-state"><?= $row['State']; ?></span>
			    <span class="badge badge-time"><time class="timeago" datetime="<?= $row['created_at']; ?>"></time></span>
			  </div>
			</div>
			<?php	} else { ?>
			<div class="card mb-3" style="width: 100%;">
			  ...
			  <video width="420" height="180" controls autoplay style="width: 100%;">
		          <source src="../../uploads/images/<?= $row['picture']; ?>" type="video/mp4">
		      </video>
			  <div class="card-body" style="padding: 0.25rem;">
			    <p class="card-text"><?= $row['Contents']; ?></p>
			    <span class="badge badge-state"><?= $row['State']; ?></span>
