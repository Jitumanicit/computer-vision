<?php
    ...
    $tranding_page_news=new fetch_data();
?>
<!DOCTYPE html>
<html lang="en">
<html>
...
<body>
  	...
  	<div class="container-fluid breaking">
  		<div class="row">
  			<ul id="ticker_03" class="ticker">
  				<?php
                      $sql=$tranding_page_news->top_breaking_news();
	...
	<div class="container-fluid mainContainer" style="margin-top: 10px;">
    	<div class="row">
    		<?php
            	$sql=$tranding_page_news->tranding_page_tranding_news();
                while($row=mysqli_fetch_array($sql))
                    {
                ?>
		    	<div class="card mb-3" style="width: 100%;">
				  <img style="height: 133px;" class="card-img-top" src="../../uploads/images/<?= $row['picture']; ?>" alt="northeast tranding news" onclick="location.href = '../news?id=<?= $row['id'];?>';">
